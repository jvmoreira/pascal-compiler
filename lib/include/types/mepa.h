...
typedef enum {
  s_program, s_var, s_integer, s_bool, s_label, s_numero, s_type, s_array, s_of, s_begin, s_end, s_procedure, s_function,
  s_goto, s_if, s_then, s_else, s_while, s_do, s_and, s_or, s_not, s_multp, s_div,
